...
class LinkAcceptorBuilder:
    ...
    def addExcludePrefix(self, *args: str):
        if args:
            self.acceptors.append(NotLinkAcceptor(IncludePrefixLinkAcceptor(list(args))))
    ...
    def addExcludeSuffix(self, *args: str):
        if args:
            self.acceptors.append(NotLinkAcceptor(IncludeSuffixLinkAcceptor(list(args))))
    ...
    def addExcludeContained(self, *args: str):
        if args:
            self.acceptors.append(NotLinkAcceptor(IncludeContainedLinkAcceptor(list(args))))
